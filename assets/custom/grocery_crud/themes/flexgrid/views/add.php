...
<h1 class="panel-heading row"><?php echo $this->l('form_add'); ?> <?php echo $subject?></h1>
	...
	<?php echo form_open( $insert_url, 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
		<div class='form-div'>
			...
			<?php if ($is_ajax) { ?><input type="hidden" class="form-control" name="is_ajax" value="true" /><?php }?>
		...
		<br/>
		<div class="pDiv">
			<div class='form-button-box form-group'>
				<input id="form-button-save" type='submit' value='<?php echo $this->l('form_save'); ?>'  class="btn btn-success btn-large"/>
			</div>
<?php 	if(!$this->unset_back_to_list) { ?>
			<div class='form-button-box form-group'>
				<input type='button' value='<?php echo $this->l('form_save_and_go_back'); ?>' id="save-and-go-back-button"  class="btn btn-success btn-large"/>
			</div>
			<div class='form-button-box form-group'>
