...
<h1 class="panel-heading row">	<?php echo $this->l('form_edit'); ?> <?php echo $subject?></h1>
	...
	<div class='form-div'>
		...
		<?php }?>
		<?php if ($is_ajax) { ?><input type="hidden" name="is_ajax" class="form-control" value="true" /><?php }?>
	...
	<div class="pDiv">
		<div class='form-button-box form-group'>
			<input  id="form-button-save form-group" type='submit' value='<?php echo $this->l('form_update_changes'); ?>' class="btn btn-success btn-large"/>
		</div>
