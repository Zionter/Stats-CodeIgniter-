...
<?php }
?></div>
<div class="flexigrid container" style='width: 97%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div id='main-table-box' class="main-table-box">
        ...
        <?php if(!$unset_add || !$unset_export || !$unset_print){?>
            <div class="Actions">
                <?php if(!$unset_add){?>
                <a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='add-anchor add_button add'>
                    <?php }?>
                    <?php if(!$unset_export) { ?>
                        <a  class="export-anchor save" title='Експорт' data-url="<?php echo $export_url; ?>" target="_blank"></a>
                    <?php } ?>
                    <?php if(!$unset_print) { ?>
                        <a class="print-anchor print" title='Друкувати' data-url="<?php echo $print_url; ?>" ></a>
                    <?php }?>
            </div>
        <?php }?>
	
	<div class="container">
		<span class="pPageStat pull-right">
	...
	<?php echo form_open( $ajax_list_url, 'method="post" id="filtering_form" class="filtering_form" autocomplete = "off" data-ajax-list-info-url="'.$ajax_list_info_url.'"'); ?>
		...
		<div class="Pagination">
			...
			<div class="btn-group btn-group-justified">
				<div class="col-md-5">
				<div class="col-md-5 input-group" style="float: left; margin-right: 15px;">
				...
				<div class="pReload pButton ajax_refresh_and_loading well well-sm col-md-1" id='ajax_refresh_and_loading'>
					<i class="glyphicon glyphicon-refresh"></i> Оновити
				</div>
	...
	<div class="sDiv quickSearchBox form-inline" id='quickSearchBox' style="display:block !important">
		<div class="sDiv2 form-group">
		<div class="input-group">
			<div class="input-group-addon"><span class="glyphicon glyphicon-search"></span></div>
			<input type="text" class="qsbsearch_fieldox search_text form-control" name="search_text" size="30" id='search_text' placeholder="Введіть для пошуку...">
		</div>
